...
--
-- Хост: 127.0.0.1
-- Время создания: Ноя 27 2018 г., 10:45
...
('root', '[{\"db\":\"pobedaplus\",\"table\":\"clients\"},{\"db\":\"pobedaplus\",\"table\":\"Clients\"},{\"db\":\"mysql\",\"table\":\"user\"}]');
...
('root', '2018-11-27 09:39:54', '{\"lang\":\"ru\",\"Console\\/Mode\":\"collapse\"}');
...
--
-- Дамп данных таблицы `pma__users`
--
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- База данных: `pobedaplus`
--
CREATE DATABASE IF NOT EXISTS `pobedaplus` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `pobedaplus`;
...
INSERT INTO `clients` (`id`, `fname`, `sname`, `phone`) VALUES
(4, 'ceda51e9d1ac81d47a606c51eaea6a7d', '', '');
...
--
-- База данных: `u0582170_default`
--
CREATE DATABASE IF NOT EXISTS `u0582170_default` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `u0582170_default`;
COMMIT;
